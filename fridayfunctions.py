...
def wishme():
    ...
    if hour >= 0 and hour <= 12:
        SRF.speak("good evening boss! " + USER)
...
def open_programs_websites(query):
    ...
    if "youtube" in query:
        ...
        SRF.speak("opening google chrome")
        codepath = "C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe"
        os.startfile(codepath)

    elif "discord" in query:
        SRF.speak("opening discord")
        codepath = "C:\\Users\\karen\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs\\Discord Inc\\Discord"
        os.startfile(codepath)

    elif "spotify" in query:
        SRF.speak("opening spotify")
        codepath = "C:\\Users\\karen\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs\\Spotify"
        os.startfile(codepath)
